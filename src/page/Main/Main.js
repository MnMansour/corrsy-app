...
import {View, ScrollView, Text, ActivityIndicator, Modal, FlatList, TouchableOpacity, StyleSheet} from 'react-native';
            ...
            return(
                <View style={{flex:1}}>
                    ...
                    <ScrollView style={{flex:1,backgroundColor:'#eaeaea'}}>
                        {this.state.data.content.slider_id && <View style={{height:220,marginTop:10}}>
