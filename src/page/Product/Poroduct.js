...
import {
    ...
    FlatList,
    TouchableOpacity,
    AsyncStorage, Modal, Picker, BackHandler,
} from 'react-native';
            ...
            return(
                <View style={{flex:1, backgroundColor: Config.background}}>
                    ...
                    <ScrollView>
                        ...
                        <SegmentedControlTab
                            values={[Lng.Courses, Lng.Information, Lng.Comments,Lng.support]}
                        ...
                        <View style={{flex:1, backgroundColor: Config.background}}>
                            ...
                            <View style={{elevation:4,flex:1, flexDirection:'row',position:'absolute',width:'100%',height:60,bottom:0,left:0,backgroundColor:'#fff'}}>
                                ...
                                <View style={{width:'40%',paddingTop:10}}>
                                    <Button onPress={()=>{}} title={'Pay'} buttonStyle={{width:'95%',alignSelf:'center',backgroundColor:'#13CE9C',borderRadius:20}}/>
                                </View>
                            </View>
                        </View>
                        <FlashMessage ref={'message'}/>
                    ...
                    <Modal onRequestClose={()=>{this.setState({modalPart:false})}} visible={this.state.modalPart}>
                        <View style={{flex:1}}>
                          { this.state.video && this.state.video.includes('youtu') ?
                            <YouTube
                              videoId={videoLink(this.state.video)}
                              play
                              loop
